...
|---------|---------|---------------|
| YAML Pipelines | Day 33 | [YAML Pipelines in Azure DevOps: When and Why](https://github.com/starkfell/100DaysOfIaC/blob/master/articles/day.33.yaml.pipelines.in.azure.devops.when.and.why.md) |
