...
while getopts ":i:t:l:r:u:p:d:x:c:v:k:b:y:" opt; do
    case "${opt}" in
        ...
        \?) # Unrecognised option - show help.
            ...
            echo -e "./createpostgres.sh -i 0b62f50c-c15a-40e2-b1ab-7ac2596a1d74 -t cf5b57b5-3bce-46f1-82b0-396341247817 -l eastus -r advwks-rg -u iac-sp -p '053c7e32-a074-4fea-a8fb-169883e9d8af' -d postgres -x 'P@ssw0rd!' -c advenwrks19 -v 9.6 -k GP_Gen5_2 -b 7 -y Disabled \\n"
            exit 2
            ;;
    esac
done
