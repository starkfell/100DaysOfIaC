...
*Today's post comes from guest contributor Tao Yang[@MrTaoYang](https://twitter.com/mrtaoyang). Tao is a Microsoft MVP who from 9-to-5 focuses on DevOps and governance in Azure. You can find Tao blogging at [Managing Cloud and Datacenter by Tao Yang](https://).*
